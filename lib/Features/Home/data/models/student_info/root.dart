...
class Root extends Equatable {
  ...
  factory Root.fromMap(Map<String, dynamic> data) => Root(
        id: data['id'] as int?,
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [Root].
  factory Root.fromJson(String data) {
    return Root.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [Root] to a JSON string.
